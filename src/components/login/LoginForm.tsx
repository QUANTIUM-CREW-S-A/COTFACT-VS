    ...
    <form onSubmit={onSubmit} className="space-y-6">
      <CardContent className="space-y-6 pt-4">
        <div className="space-y-3">
          <Label 
            ...
            className={cn(
              ...
              formFocused === "username" ? "text-blue-700" : "text-gray-700"
            )}
          >
          ...
          >
            ...
            <Input
              ...
              className={cn(
                ...
                formFocused === "username" ? "border-blue-400 bg-white" : ""
              )}
              required
              autoFocus
        ...
        <div className="space-y-3">
          <Label 
            ...
            className={cn(
              "text-sm font-medium transition-colors duration-200",
              formFocused === "password" ? "text-blue-700" : "text-gray-700"
            )}
          >
            Contraseña
          </Label>
          ...
          >
            ...
            <Input
              ...
              className={cn(
                "pl-10 py-6 pr-10 bg-gray-50 border-gray-200 focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:ring-blue-500 transition-all",
                formFocused === "password" ? "border-blue-400 bg-white" : ""
              )}
              required
          ...
          <div className="text-right">
            <Button 
              type="button" 
              variant="link" 
              className="text-sm text-blue-600 p-0 h-auto font-normal hover:text-blue-800 transition-colors"
              onClick={(e) => {
                e.preventDefault();
                onForgotPassword();
              }}
      ...
      <CardFooter className="flex flex-col pb-8">
        <Button
          ...
          disabled={isLoading}
          className={cn(
            "w-full bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-blue-200 transition-all py-6",
